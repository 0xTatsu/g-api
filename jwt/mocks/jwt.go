...
// ClaimsFromCtx provides a mock function with given fields: ctx
func (_m *JWT) ClaimsFromCtx(ctx context.Context) jwt.AccessClaims {
	ret := _m.Called(ctx)

	var r0 jwt.AccessClaims
	if rf, ok := ret.Get(0).(func(context.Context) jwt.AccessClaims); ok {
		r0 = rf(ctx)
	} else {
		r0 = ret.Get(0).(jwt.AccessClaims)
	}
...
// RefreshClaimsFromCtx provides a mock function with given fields: ctx
func (_m *JWT) RefreshClaimsFromCtx(ctx context.Context) jwt.RefreshClaims {
	ret := _m.Called(ctx)

	var r0 jwt.RefreshClaims
	if rf, ok := ret.Get(0).(func(context.Context) jwt.RefreshClaims); ok {
		r0 = rf(ctx)
	} else {
		r0 = ret.Get(0).(jwt.RefreshClaims)
	}
